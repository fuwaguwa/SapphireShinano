...
export class JPTweetsTranslateButtonHandler extends InteractionHandler
{
	public override parse(interaction: ButtonInteraction)
	{
		if (!interaction.customId.includes("JTWT")) return this.none();
	...
	public override async run(interaction: ButtonInteraction)
	{
		...
		fs.readFile(join(rootDir, "data", "tweetsInfo.json"), "utf-8", (err, data) =>
		{
